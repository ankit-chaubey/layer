...
impl Button {
    ...
    pub fn callback(text: impl Into<String>, data: impl Into<Vec<u8>>) -> Self {
        Self {
            inner: tl::enums::KeyboardButton::Callback(
    ...
    pub fn url(text: impl Into<String>, url: impl Into<String>) -> Self {
        Self {
            inner: tl::enums::KeyboardButton::Url(
    ...
    pub fn url_auth(text: impl Into<String>, url: impl Into<String>, fwd_text: Option<String>, bot: tl::enums::InputUser) -> Self {
        Self {
    ...
    pub fn text(label: impl Into<String>) -> Self {
        Self {
            inner: tl::enums::KeyboardButton::KeyboardButton(
                tl::types::KeyboardButton { text: label.into(), style: None },
            ),
        }
    }
...
impl InlineKeyboard {
    ...
    pub fn into_markup(self) -> tl::enums::ReplyMarkup {
        ...
        tl::enums::ReplyMarkup::ReplyInlineMarkup(
            tl::types::ReplyInlineMarkup { rows }
        )
    }
}
...
impl ReplyKeyboard {
    ...
    pub fn resize(mut self) -> Self { self.resize = true; self }

    /// Hide keyboard after a single press.
    pub fn single_use(mut self) -> Self { self.single_use = true; self }

    /// Show keyboard only to mentioned/replied users.
    pub fn selective(mut self) -> Self { self.selective = true; self }
    ...
    pub fn into_markup(self) -> tl::enums::ReplyMarkup {
        ...
        tl::enums::ReplyMarkup::ReplyKeyboardMarkup(
